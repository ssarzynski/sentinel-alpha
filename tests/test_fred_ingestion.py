...
from sentinel_alpha.fred_ingestion import FredClient, FRED_SERIES, load_macro_inputs
...
def test_cpi_is_requested_as_year_over_year_percent_change():
    ...
    cpi_call = next(call for call in calls if call["series_id"] == [FRED_SERIES["inflation_yoy"]])
