...
from sentinel_alpha.treasury_ingestion import TreasuryClient, cross_validate_yields, treasury_macro_inputs
...
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata" xmlns:d="http://schemas.microsoft.com/ado/2007/08/dataservices">
 <entry><content type="application/xml"><m:properties>
  <d:NEW_DATE>2026-09-16T00:00:00</d:NEW_DATE><d:BC_2YEAR>3.75</d:BC_2YEAR><d:BC_10YEAR>4.12</d:BC_10YEAR>
 </m:properties></content></entry>
 <entry><content type="application/xml"><m:properties>
  <d:NEW_DATE>2026-09-17T00:00:00</d:NEW_DATE><d:BC_2YEAR>3.72</d:BC_2YEAR><d:BC_10YEAR>4.10</d:BC_10YEAR>
 </m:properties></content></entry>
</feed>'''
...
def _input(metric, value):
    return MacroInput(metric, value, datetime(2026, 9, 17, tzinfo=timezone.utc), "test", timedelta(days=5))


def test_cross_validation_reports_difference_without_overwriting():
    primary = {"treasury_2y": _input("treasury_2y", 3.72), "treasury_10y": _input("treasury_10y", 4.10)}
    comparison = {"treasury_2y": _input("treasury_2y", 3.74), "treasury_10y": _input("treasury_10y", 4.18)}
...
def test_cross_validation_fails_closed_on_missing_metric():
    with pytest.raises(ValueError, match="missing treasury_10y"):
        cross_validate_yields(
            {"treasury_2y": _input("treasury_2y", 3.7), "treasury_10y": _input("treasury_10y", 4.1)},
